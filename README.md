...
<table>
    ...
    <tr>
        ...
        <td> Non-parametric recursive partitioning builder for survival curves. Builds a Kaplan–Meier curves for each partition/leaf. 'log Rank', 'Wasserstein Distance' and 'Brier Scores' based based criterion is available.</td>
        <td>No</td>
        <td>Yes</td>
    </tr>
        </tr>
